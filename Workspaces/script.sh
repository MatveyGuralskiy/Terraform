...
<head>
    ...
    <title>Terraform Webserver Workspaces</title>
    <style>
        h1 {
...
<body>
    <h1>Terraform Webserver Workspaces</h1>
    <p>Server using Terraform Workspaces for Testing before Deployment</p>
    ...
    <p>Testing1 was Complete successfully</p>
    <p>Testing2 was Complete successfully</p>
    <p>Website is ready for Deployment!</p>
</body>
</html>
EOF
)
